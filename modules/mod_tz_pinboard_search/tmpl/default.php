...
<div id="Tz_pinboard">
    <div id="tz_from">
        <form method="post" action="<?php echo JRoute::_('index.php'); ?>">
            <div class="search">
                <input autocomplete="off" id="tz_search" type="text" name="tz_search" value=""
                       placeholder="<?php echo JText::_('MOD_TZ_PINBOARD_SEARCH'); ?>">
                <button id="tz_submit" type="submit" name="submit" value="Search"></button>
