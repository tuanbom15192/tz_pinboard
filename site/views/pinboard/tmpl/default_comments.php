        ...
        <li>
            <?php if (isset($this->displayComment[$i]->img_user) && !empty($this->displayComment[$i]->img_user)) { ?>
                <img class="tz_more_conten_comment_imgs"
                     src="<?php echo JUri::root() . '/' . $this->displayComment[$i]->img_user; ?>">
            <?php } else { ?>
                <img class="tz_more_conten_comment_imgs"
            ...
            <a rel="nofollow"
               href="<?php echo JRoute::_(TZ_PinboardHelperRoute::getPinboardManageruserRoute($this->displayComment[$i]->id_user)); ?>">
