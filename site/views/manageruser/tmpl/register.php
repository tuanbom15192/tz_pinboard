...
<div class="registration<?php echo $this->pageclass_sfx ?>">
    ...
    <form id="member-registration"
                        ...
                        <?php else: ?>
                            ...
                            <?php if (($field->fieldname) == 'email2'): ?>
                                <div class="control-group">
                                    <div class="control-label">
                                        <label
                                            title="<?php echo JText::_('COM_TZ_PINBOARD_USER_FIELD_GENDER_LABEL'); ?>::<?php echo JText::_('COM_TZ_PINBOARD_USER_FIELD_GENDER_LABEL_DESC'); ?>"
                                            class="hasTip required"
                                            >
                                            <?php echo JText::_('COM_TZ_PINBOARD_USER_FIELD_GENDER_LABEL'); ?>
                                        </label>
                                    </div>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <div class="control-label">
                                        <label id="jform_TZclient_images-lbl"
                                               class=""
                                               for="jform_TZclient_images"
                                               aria-invalid="false">
                                            <?php echo JText::_('COM_TZ_PINBOARD_USER_FIELD_CLIENT_IMAGES_LABEL') ?>
                                        </label>
                                    </div>
                                    <div class="controls">
                                        <input id="jform_TZclient_images"
                                               type="file"
                                               size="50"
                                               name="jform[TZclient_images]"
                                               class=""/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="control-label">
                                        <label id="jform_url_images-lbl"
                                               ...
                                               aria-invalid="false">
                                            <?php echo JText::_('COM_TZ_PINBOARD_USER_FIELD_URL_IMAGES_LABEL'); ?></label>
                                    </div>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <div class="control-label">
                                        <label><?php echo JText::_('COM_TZ_PINBOARD_TWITTER_LABEL'); ?></label>
                                    </div>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <div class="control-label">
                                        <label><?php echo JText::_('COM_TZ_PINBOARD_FACEBOOK_LABEL'); ?></label>
                                    </div>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <div class="control-label">
                                        <label><?php echo JText::_('COM_TZ_PINBOARD_GOOGLE_PLUS_LABEL'); ?></label>
                                    </div>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <div class="control-label">
                                        <label><?php echo JText::_('COM_TZ_PINBOARD_DESCRIPTION'); ?></label>
                                    </div>
                                    <div class="controls">
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary validate"><span><?php echo JText::_('JREGISTER'); ?></span>
            </button>
