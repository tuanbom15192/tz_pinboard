...
jQuery(document).ready(function () {
    ...
    jQuery(".Tz_delete .tz_comment_delete").live(event, function () {
...
if (isset($this->showboardandpin) && !empty($this->showboardandpin)) {
    foreach ($this->showboardandpin as $Pins) {
        ?>
        <div class="tz_pin_content_class">
            <div class="tz_thumbnail thumbnail">
                ...
                <?php if (isset($this->count_button) && $this->count_button == 1) { ?>
                    <p>
                        <span
                            class="tz_pin_like"><?php echo $Pins->number_like->num_like; ?> <?php echo JText::_('COM_TZ_PINBOARD_MANAGERUSER_LIKES'); ?></span>
                        <span
                            class="tz_pin_comment"><?php echo $Pins->number_comment->count_l; ?>   <?php echo JText::_('COM_TZ_PINBOARD_MANAGERUSER_COMMENT'); ?></span>
                        <span
                    ...
                    <div class="tz_button_pins">
                        ...
                        if ($Pins->id_user == $this->sosanhuser) {
                            ...
                            <a class="tz_button_repin "
                               href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&task=tz.edit.pins&view=manageruser&id_pins=' . $Pins->content_id) ?>"
                               rel="nofollow">
                                    <span>
                ...
                if (isset($this->s_user) && $this->s_user == 1) {
                    ...
                    <p>
                        ...
                        if (isset($Pins->website) && !empty($Pins->website)) {
                            ?>
                            <a class="tz_pin_content_class_2_web" href="<?php echo $Pins->website; ?>" target="_blank"
                               rel="nofollow">
                                <?php
                        ...
                        <?php
                            ...
                            <a class="tz_pin_content_class_2_web "
                               href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=manageruser&id_guest=' . $Pins->id_user_repin); ?>"
                               rel="nofollow">
                ...
                <div class="tz_pin_comsPins">
                    <?php if (isset($this->s_thumb) && $this->s_thumb == 1) { ?>
                        <div class="tz_pin_comsPins_content">
                            <?php
                            if (isset($Pins->showcomment) && ($Pins->number_comment->count_l > $this->page_com)) {
                                ?>
