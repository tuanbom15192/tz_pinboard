                        ...
                        <div class="tz_pin_following_left">
                            <?php if (isset($followes->tzimages) && !empty($followes->tzimages)) { ?>
                                <img class="tz_pin_following_left_img"
                                     src="<?php echo JUri::root() . '/' . $followes->tzimages; ?>">
                            <?php } else { ?>
                                <img class="tz_pin_following_left_img"
                        ...
                        <div class="tz_pin_following_right">
                            <ul>
                                <li class="tz_pin_following_right_li1">
                                    <a href="<?php echo JRoute::_(TZ_PinboardHelperRoute::getPinboardManageruserRoute($followes->uid)); ?>"
                                       rel="nofollow">
                                    ...
                                    if ($followes->uid != $this->sosanhuser) {
                                        if ($followes->followCheck['f'] == '0' || $followes->followCheck['f'] == '') {
                                            ...
                                            ?>
                                            <button class="tz_pin_following_button btn tz_following"
                                                    data-option-id="<?php echo $followes->uid ?>">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <button class="tz_pin_following_button untz_following btn disabled"
                                                    data-option-id="<?php echo $followes->uid ?>">
                                ...
                                <li class="tz_pin_following_right_li2">
                                    ...
                                    for ($i = 0; $i < $dem; $i++) {
                                        ...
                                        <a class="tz_pin_following_button_a"
                                           href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=manageruser&task=tz.more.board&id_guest=' . $followes->follow[$i]->cid . '&id_board=' . $followes->follow[$i]->bordid); ?>"
                                           rel="nofollow">
                                            <img class="tz_pin_following_left_img"
