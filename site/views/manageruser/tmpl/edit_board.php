...
<div id="tz_pinboard_warp_edit">
    <div id="tz_pinboard_warp_edit_herder">
        <img id="tz_pinboard_warp_edit_img"
             src="<?php echo JUri::root() . '/components/com_tz_pinboard/images/edit.png' ?>">
        <span>
    ...
    <div id="tz_pinboard_warp_edit_content">
        <form action="<?php echo JRoute::_('index.php'); ?>" method="post">
            <div class="tz_edit_board_1">
                ...
                <input id="boardname" maxlength="<?php echo $this->max_text_board; ?>" type="text" name="editname"
                       value="<?php echo $this->editboard->board; ?>"/>
            ...
            <div class="tz_edit_board_1">
                ...
                <input id="aliasboard" maxlength="<?php echo $this->max_text_board; ?>" type="text" name="aliasboard"
                       value="<?php echo $this->editboard->alias; ?>"/>

                <p id="p_create_aliasname"></p>
            </div>
            <div class="tz_edit_board_2">
                <label><?php echo JText::_('COM_TZ_PINBOARD_MANAGERUSER_DESCRIPTION'); ?></label>
                <textarea name="textreaname" maxlength="<?php echo $this->max_text_board_ds; ?>"
                          id="tz_edit_board_2_textra"
                          style="width: 370px; height: 110px;"><?php echo $this->editboard->description; ?></textarea>
    ...
    <div id="tz_pinboard_warp_delete_board">
        ...
        <div id="tz_pinboard_warp_delete">
            <?php if ($this->editboard->check->count_id == '0') { ?>
                ...
                <a href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=manageruser&task=tz.delete&id_board=' . $this->editboard->id_board); ?>"
                   rel="nofollow">
